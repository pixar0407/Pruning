...
parser.add_argument('--lr', type=float, default=0.0000015, metavar='LR', #경록
...
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/lr_v2_L2x_10e.ckpt') # 경록
...
util.log(args.log, f"initial_accuracy {accuracy}")
# torch.save(model, f"/content/gdrive/My Drive/data/model_L1_30e.ptmodel") # 경록
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/lr_v2_L2x_20e.ckpt') # 경록
...
util.log(args.log, f"initial_accuracy {accuracy}")
# torch.save(model, f"/content/gdrive/My Drive/data/model_L1_30e.ptmodel") # 경록
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/lr_v2_L2x_30e.ckpt') # 경록

print("---3th  Initial training ---")
train(args.epochs)
accuracy = test()
util.log(args.log, f"initial_accuracy {accuracy}")
torch.save(model, f"/content/gdrive/My Drive/data/lr_v2_L2x_40e.ptmodel") # 경록
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/lr_v2_L2x_40e.ckpt') # 경록
