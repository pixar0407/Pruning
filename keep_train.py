...
model.load_state_dict(torch.load('/content/gdrive/My Drive/data/model_L1_70e.ckpt', map_location="cpu")) # 경록
...
torch.save(model, f"/content/gdrive/My Drive/data/model_L1_80e.ptmodel") # 경록
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/model_L1_80e.ckpt')# 경록
