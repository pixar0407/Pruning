...
model.load_state_dict(torch.load('/content/gdrive/My Drive/data/L2x_50e.ckpt', map_location="cpu")) # 경록
...
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/L2x_60e.ckpt')# 경록
...
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/L2x_70e.ckpt')# 경록
...
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/L2x_80e.ckpt')# 경록
...
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/L2x_90e.ckpt')# 경록
...
util.log(args.log, f"initial_accuracy {accuracy}")
# torch.save(model, f"/content/gdrive/My Drive/data/model_L1_150e.ptmodel") # 경록
torch.save(model.state_dict(), '/content/gdrive/My Drive/data/L2x_100e.ckpt')# 경록
